Feature: Feedback explorer
  ...
  Scenario: explore using URL
    ...
    Then the following result is shown:
      ...
      | 01.03.2013    | action: looking at 3rd paragraph problem: typo in 2rd word | /vat-rates | https://www.gov.uk         |
      | 01.02.2013    | action: looking at rates problem: standard rate is wrong   | /vat-rates | https://www.gov.uk/pay-vat |
