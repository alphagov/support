  ...
  module Permissions
    class Ability
      ...
      def initialize(user)
        ...
        can :create, [Support::Requests::CreateUserRequest, Support::Requests::AccountsPermissionsAndTrainingRequest, Support::Requests::RemoveUserRequest] if user.has_permission?("user_managers")
